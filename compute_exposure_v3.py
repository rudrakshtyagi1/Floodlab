...
out_dir = "/workspace/data/processed/tehri_simulations/exposure/v3"
depth_ds = gdal.Open("/workspace/data/processed/tehri_simulations/lisflood_fp/outputs/v3_geometry_corrected/rasters/max_depth_v3.tif")
arr_ds = gdal.Open("/workspace/data/processed/tehri_simulations/lisflood_fp/outputs/v3_geometry_corrected/rasters/arrival_time_v3.tif")
...
summary = {
    "scenario_metadata": {
        "hazard_provenance": "MODELLED LISFLOOD-FP V3 GEOMETRY-CORRECTED BENCHMARK",
